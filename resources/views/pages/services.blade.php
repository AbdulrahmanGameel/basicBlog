...
@if (count($services))
    ...
    <ul class="list-group ">
        ...
        <li class="list-group-item p-3 mb-2 bg-white text-dark"> {{$service}}</li>        
        @endforeach
    </ul>
@endif
...
<div id="ToS">
    <pre style=" white-space: pre-wrap;">
        ...
        By accessing this website we assume you accept these terms and conditions. Do not continue to use Basic Blog if you do not agree to take all of the terms and conditions stated on this page.
        ...
        Cookies
        We employ the use of cookies. By accessing Basic Blog, you agreed to use cookies in agreement with the Company Name's Privacy Policy.
        
        Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
        
        License
        Unless otherwise stated, Company Name and/or its licensors own the intellectual property rights for all material on Basic Blog. All intellectual property rights are reserved. You may access this from Basic Blog for your own personal use subjected to restrictions set in these terms and conditions.
        
        You must not:
        
        Republish material from Basic Blog
        Sell, rent or sub-license material from Basic Blog
        Reproduce, duplicate or copy material from Basic Blog
        Redistribute content from Basic Blog
